  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      ...
      <main className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-5 pt-16 text-center sm:px-8 sm:pt-24 lg:pt-28">
        ...
        {/* ── URL Input ── */}
        <form className="animate-fade-in-up delay-400 mt-8 w-full max-w-xl sm:mt-10">
          <div className="input-container animate-pulse-glow flex flex-col gap-2 p-2 sm:flex-row sm:items-center sm:gap-0">
            ...
            <button
              type="submit"
              id="analyze-button"
              className="flex shrink-0 items-center justify-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-semibold text-background transition-all hover:bg-accent-hover hover:shadow-[0_0_20px_rgba(0,212,126,0.25)] active:scale-[0.98] sm:px-6 sm:text-base"
            >
              Analyze My Store
